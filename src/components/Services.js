              ...
              <div className="container">
                ...
                <motion.div className="services-box" whileInView={fade} initial={{opacity: 0}}>
                    ...
                    <div className="services-card">
                        ...
                        <p className='services-title'>Mobile App Development</p>
                        <p className='services-desc'>I create native and cross-platform mobile applications using React Native and modern mobile development frameworks for iOS and Android platforms. </p>
                    </div>
                </motion.div>
              </div>
          </div>
